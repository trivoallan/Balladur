      ...
      <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tbody>
          <tr v-for="detail in trackList" :key="detail.id">
            ...
            <td class="border-t-0 p-2 px-4 align-middle border-l-0 border-r-0 text-s p-4">{{ detail.album }}</td>
            ...
            <td class="border-t-0 p-2 px-4 align-middle border-l-0 border-r-0 text-s p-4">
              <i class="fas fa-circle text-orange-500 mr-2"></i>{{ detail.added_at }}
            </td>
            <td class="border-t-0 p-2 px-4 align-middle border-l-0 border-r-0 text-s p-4">
